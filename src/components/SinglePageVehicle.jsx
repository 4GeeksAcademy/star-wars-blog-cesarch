    ...
    return (
            <div className="container text-center">
              ...
              <div className="row justify-content-between my-3 text-center">
                <div className="col-2 bg-light border">{vehicles?.name}</div>
                <div className="col-2 bg-danger border">{vehicles?.model}</div>
                <div className="col-2 bg-primary border">{vehicles?.vehicle_class}</div>
                <div className="col-2 bg-light border">{vehicles?.cost_in_credits}</div>
                <div className="col-2 bg-light border">{vehicles?.passengers}</div>
                <div className="col-2 bg-light border">{vehicles?.manufacturer}</div>
              </div>
            </div>
          );
